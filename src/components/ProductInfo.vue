    ...
    <div class="product-content">
        ...
        <div class="swatch-size">
            ...
            <div class="watch-selected-size">
                <label>
                <input type="radio" name="swatch_1234" value="XS" v-model="pickSize" />
                <span class="item-show"  >
                    <div class="mona-bg">XS</div>
                </span>
                </label>
                <label>
                <input type="radio" name="swatch_1234" value="S" v-model="pickSize" />
                <span class="item-show" >
                    <div class="mona-bg">S</div>
                </span>
                </label> 
                <label>
                <input type="radio" name="swatch_1234" value="M" v-model="pickSize" />
                <span class="item-show" >
                    <div class="mona-bg">M</div>
                </span>
                </label>
                <label>
                <input type="radio" name="swatch_1234" value="L" v-model="pickSize"/>
                <span class="item-show" >
                    <div class="mona-bg">L</div>
                </span>
                </label>
                <label>
                <input type="radio" name="swatch_1234" value="XL" v-model="pickSize" />
                <span class="item-show" >
                    <div class="mona-bg">XL</div>
                </span>
                </label>
            </div>
...
import AppButton from '@/components/AppButton.vue'
    ...
    methods: {
        ...
        buyProduct(){
            this.$emit("buyProduct", this.Products, this.quantity,this.pickSize);
